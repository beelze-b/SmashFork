...
###########################################################################################
	def data_preparation(self, adata):
		# if True: convert data from sparse to dense matrix 
	...
	###########################################################################################
	# decide if call batch effect removal or not 
	# this step require a lot of time for big dataset
	def harmonise_data(self, adata):
		# batch effect removal using batch in .obs
		# harmony is applied on .X
		# store in .X the count scaled values
